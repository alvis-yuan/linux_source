...
static void _ProcessRequest(void)
{
    ...
    switch (g_cpContext.currentRequest.type) {
        ...
        case kCPMsgSignChallenge:
            ...
            success = _ExecuteSignChallenge((uint8_t *)
                                            g_cpContext.currentRequest.challengeData,
                                     ...
                                     uint32_t challengeLen)
{
    ...
    if (type == kCPMsgSignChallenge && challengeData && challengeLen > 0) {
        ...
        memcpy((void *)g_cpContext.currentRequest.challengeData, challengeData,
               challengeLen);
                                    ...
                                    uint32_t challengeLen)
{
    ...
    if (g_cpContext.config.useThread) {
        return _SubmitRequestThreadMode(kCPMsgSignChallenge, challengeData,
                                        challengeLen);
    }
